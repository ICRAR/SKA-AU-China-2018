...
Call this by using:
    ...
    python se-test2-export-graph.py 202.127.29.97 <ngas_id> --port 8002
"""
import argparse
import json
import logging
...
FILE_NAME = '/home/ska_au_china_2018/fileidlist.txt'
...
class BuildGraph(AbstractBuildGraph):
    def __init__(self, **kwargs):
        ...
        self._ngas_id = kwargs['ngas_id']

    def build(self):
        with open(FILE_NAME, 'w') as ngas_file:
            ngas_file.write(self._ngas_id)
...
def main():
    ...
    parser.add_argument('ngas_id', help='the NGAS id')
